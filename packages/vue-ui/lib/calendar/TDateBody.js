...
var TDateBody_vue_vue_type_template_lang = require("./TDateBody.vue_vue_type_template_lang.js");
...
const __vue2_script = {
  ...
  data() {
    return {
      ROW: dataConstant.DATE_ROW_COUNT,
      COL: dataConstant.DATE_COL_COUNT
    };
  },
  computed: {
    total() {
      return dayjs_min(this.value).daysInMonth();
    },
    dateTable() {
      let current;
      let passed = 0;
      const dateTable = [];
      for (let iIndex = 0; iIndex < dataConstant.DATE_ROW_COUNT; iIndex++) {
        for (let jIndex = 0; jIndex < dataConstant.DATE_COL_COUNT; jIndex++) {
...
const __cssModules = {};
var __component__ = /* @__PURE__ */ vueComponentNormalizer(__vue2_script, TDateBody_vue_vue_type_template_lang.render, TDateBody_vue_vue_type_template_lang.staticRenderFns, false, __vue2_injectStyles, null, null, null);
